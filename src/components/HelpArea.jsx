...
const HELP_ITEMS = [
  ...
  },
  {
    ...
    text: 'GitHub Actions is an automation service delivered by the company Github (or CI / CD service) that helps you automate repository-related workflows and processes.',
  },
];
